...
import { RigRouter, ActionRouter, MinerGroupRouter, MinerClientRouter, WalletRouter, ProfileOptionRouter, PoolRouter } from './router';
...
class Server {
    ...
    public routes(): void {
        ...
        this.app.use('/api/v1/profileoption', ProfileOptionRouter);
        this.app.use('/api/v1/pool', PoolRouter);
    }
}
